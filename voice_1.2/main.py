...
def wishme():
    ...
    welcome_message = (f"{greeting}, sir! I am your voice assistant. "
                       f"Current temperature is {weather_info['temp']} degrees Celsius. "
                       f"Weather description is {weather_info['description']}. "
                       f"The current time is {now}. "
                       f"Here to assist you with various tasks. How can I help you today?")
    
    speak(welcome_message)
    update_dialog(welcome_message)
...
# Run the Tkinter main loop first
window.after(1000, wishme)  # Delay calling wishme to ensure window appears first
